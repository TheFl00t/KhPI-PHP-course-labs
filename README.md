...
### Статус виконання:
- [x] Лабораторна робота №1 - Ознайомлення із синтаксисом PHP
- [x] Лабораторна робота №2 - Файли та файлова структура
- [x] Лабораторна робота №3 - Глобальні массиви \$_COOKIE, \$_SESSION, \$_SERVER
- [x] Лабораторна робота №4 - ООП
- [x] Лабораторна робота №5 - ООП
- [x] Лабораторна робота №6 - MySQL
- [x] Лабораторна робота №7 - Кешування ([Дивитись звіт](https://github.com/TheFl00t/KhPI-PHP-course-labs/blob/main/public/lab7/%D0%97%D0%B2i%D1%82/README.md))
